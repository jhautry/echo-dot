...
# User Stories
As a **normal user**, I want to **give verbal requests to Alexa** (play music, order a pizza, voice control my smart-home, request an Uber, etc.) so I can **have her automate tasks for me like a personal assistant**.
...
---
As a **normal user**, I want to **feel confident that the Echo Dot is secure** so I can **trust it to safely handle the security of my house and online accounts**.

Acceptance Criteria:
* A comprehensive overview of the information 
  
---
As a **normal user**, I want to **download and install a useful Alexa Skill** to my Echo Dot so I can **add new features over time**.
